...
I've waited a _long_ time for this possibility! They first teased it in the innocuous waining paragraphs of a blog looking at [the then nascent support for RISC-V](https://medium.com/graalvm/graalvm-native-image-meets-risc-v-899be38eddd9)! I've been waiting for it ever since! 
...
You can run `main.js` with `node` (tho, note you'll need Node 22 or higher!) thusly:

`node main.js`

Do you see `Hello, WebAssembly!`? If so, congrats! You just wrote your first real Java.. Script!

The possibilities here are endless! Did you see they [even hava `javac` running in the browser?](https://graalvm.github.io/graalvm-demos/native-image/wasm-javac/)
