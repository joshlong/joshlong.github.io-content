...
I talked to Matt Raible who showed me Hammersmith which I installed use ye ol package maanager Homebrew: `brew install --cask hammersmith`. I wanted it to work like Shiftit did, so after installing it, 
...
Once I went to the Hammersmith preferences and reloaded the configuration, everything worked a charm. Thanks, [Matt](https://twitter.com/mraible)!
