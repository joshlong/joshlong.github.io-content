...
**UPDATE** (2023-11-20) maybe it was too good to be true? I noticed that, while it does indeed reach the otherside of the condo, and it is indeed _much_ faster on the other side of the condo, compared to when I had the older Eero setup with the beacon repeater setup, it sometimes flakes out and drops, awkwardly right in the middle of somthing important like a phone call or Zoom meeting. I'm not sure if the sheer number of devices is overwhelming it or the signal attenuates when the wind changes, or what, so I purchased a _second_ Eero to act as a node (not the gateway). It was super easy to set this one up. I just went to the Eero application, added a device, and voilà, it was up and running, extending the signal from the first one. Time will tell if we've also eliminated the flakiness...
